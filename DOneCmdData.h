#include "COneCmdData.h"


void Ddef1(string input)
{
...
void Dcmdreply(string input, int frame) //needed because def(input) will NOT go directly into cout statement
{
...
int Dgetcmdline(int frame, string item)
{
