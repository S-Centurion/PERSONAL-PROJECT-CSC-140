...
void Bcmdreply(string input, int frame) //needed because def(input) will NOT go directly into cout statement
{
...
int Bgetcmdline(int frame, string item)
{
