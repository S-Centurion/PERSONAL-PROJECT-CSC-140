#include "DOneCmdData.h"


void Edef1(string input)
{
...
void Ecmdreply(string input, int frame) //needed because def(input) will NOT go directly into cout statement
{
...
int Egetcmdline(int frame, string item)
{
