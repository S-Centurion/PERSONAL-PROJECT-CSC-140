#include "BOneCmdData.h"


void Cdef1(string input)
{
...
void Ccmdreply(string input, int frame) //needed because def(input) will NOT go directly into cout statement
{
...
int Cgetcmdline(int frame, string item)
{
