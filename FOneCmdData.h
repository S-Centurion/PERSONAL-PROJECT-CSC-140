#include "EOneCmdData.h"


void Fdef1(string input)
{
...
void Fcmdreply(string input, int frame) //needed because def(input) will NOT go directly into cout statement
{
...
int Fgetcmdline(int frame, string item)
{
