#include "FOneCmdData.h"


void Gdef1(string input)
{
...
void Gcmdreply(string input, int frame) //needed because def(input) will NOT go directly into cout statement
{
...
int Ggetcmdline(int frame, string item)
{
