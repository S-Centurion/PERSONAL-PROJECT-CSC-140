#include "GOneCmdData.h"


void Hdef1(string input)
{
...
void Hcmdreply(string input, int frame) //needed because def(input) will NOT go directly into cout statement
{
...
int Hgetcmdline(int frame, string item)
{
